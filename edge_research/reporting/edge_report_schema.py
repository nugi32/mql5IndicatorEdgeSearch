...
class RobustnessReport:
    ...
    # Output of validate_holding_bars_walk_forward, PLUS the full
    # scan_holding_horizons table under 'scan_table' -- kept here (not
    # thrown away after selection) so the chosen holding_bars is auditable
    # from the report alone, not a number that has to be trusted blindly.
    holding_bars: Dict[str, Any] = field(default_factory=dict)
